...
-keep public class * extends com.cjq.aijia.BaseActivity      # 保持哪些类不被混淆
...
-keepclassmembers class * extends com.cjq.bejingunion.BaseActivity { # 保持自定义控件类不被混淆
    public void *(android.view.View);
}
...
-keep class com.cjq.aijia.activity.*{*;}
-keep class com.cjq.aijia.fragments.*{*;}
-keep class com.cjq.aijia.reveiver.*{*;}

# 保证继承自BmobObject、BmobUser类的JavaBean不被混淆
-keep class com.example.bmobexample.Person{*;}
-keep class com.cjq.bejingunion.MainActivity{*;}
